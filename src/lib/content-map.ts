...
export const features: Record<string, Feature> = {
  ...
  'Leading Change': {
    ...
    opener: { src: 'leading-change-collage.jpg', alt: 'Arevik Ohanyan, Jen Pollard, and Laura S. Abreu Malla', credit: 'Courtesy of Arevik Ohanyan, Jen Pollard, and Laura S. Abreu Malla', format: 'collage' },
    inline: [
